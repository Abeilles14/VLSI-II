...
Ts=1e-12; %%% time step to sample
nsym_short=500*100e-12/Tsym; 	%%% persistence of the impulse response


FileName = 'C:\Research\ELEC403\peters_01_0605_B1_thru.s4p';
...
Htitle = get(AX, 'title');
set(Htitle, 'string', 'Backplane Channel','FontName','utopia', 'FontSize', [20], 'Color', [0 0 0]);
%L=legend('1','2','3','4',2);
%set(L, 'FontSize', [14]);
grid on;
